...
sph_calc01 = SpheriCalc(n1=1.00, n2=1.52, s1='inf', r=+3, s2=None)
#sph_calc01 = SpheriCalc(n1=1.00, n2=1.52, s2='-inf', r=+3, s1=None)
sph_calc01 = SpheriCalc(n1=1.00, n2=1.52, s1=-12, r=+3, s2=None)
print(sph_calc01)
fig1 = sph_calc01.plot1(xlim=(-13, 20))
plt.show()
